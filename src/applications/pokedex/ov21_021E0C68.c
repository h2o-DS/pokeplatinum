...
static void ov21_021E0FBC(PokedexGraphicData **param0, int heapID)
{
    ...
    v0 = PokedexGraphics_GetGraphicNarcScreenData(*param0, foreign_entry_window_NSCR_lz, TRUE, &v1, heapID);

    Bg_LoadToTilemapRect((*param0)->bgConfig, 3, v1->rawData, 0, 16, v1->screenWidth / 8, v1->screenHeight / 8);
    Heap_FreeToHeap(v0);

    v0 = PokedexGraphics_GetGraphicNarcScreenData(*param0, foreign_summary_window_NSCR_lz, TRUE, &v1, heapID);
...
static void ov21_021E127C(UnkStruct_ov21_021E14D4 *param0, PokedexGraphicData **param1, int param2)
{
    ...
    param0->unk_08[2] = SpriteResourceCollection_AddFrom(v0->spriteResourceCollection[2], v1, type_icons_cell_NCER_lz, TRUE, type_icons_cell_NCER_lz + 4000, SPRITE_RESOURCE_CELL, param2);
    param0->unk_08[3] = SpriteResourceCollection_AddFrom(v0->spriteResourceCollection[3], v1, type_icons_anim_NANR_lz, TRUE, type_icons_anim_NANR_lz + 4000, SPRITE_RESOURCE_ANIM, param2);
}

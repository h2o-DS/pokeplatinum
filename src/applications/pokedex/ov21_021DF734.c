...
static void ov21_021DFAE8(UnkStruct_ov21_021DF858 *param0, int heapID)
{
    ...
    v0 = PokedexGraphics_GetGraphicNarcScreenData(param0->unk_00, info_main_NSCR_lz, TRUE, &v1, heapID);
...
static void ov21_021DFD1C(UnkStruct_ov21_021DFFF8 *param0, UnkStruct_ov21_021DF858 *param1, int param2)
{
    ...
    param0->unk_10[0] = SpriteResourceCollection_AddTilesFrom(v0->spriteResourceCollection[0], v1, form_display_box_NCGR_lz, TRUE, form_display_box_NCGR_lz + 14000, NNS_G2D_VRAM_TYPE_2DMAIN, param2);

    SpriteTransfer_RequestCharAtEnd(param0->unk_10[0]);
    SpriteResource_ReleaseData(param0->unk_10[0]);

    param0->unk_10[1] = SpriteResourceCollection_AddPaletteFrom(v0->spriteResourceCollection[1], v1, form_display_box_NCLR, FALSE, form_display_box_NCLR + 14000, NNS_G2D_VRAM_TYPE_2DMAIN, 1, param2);

    SpriteTransfer_RequestPlttFreeSpace(param0->unk_10[1]);
    SpriteResource_ReleaseData(param0->unk_10[1]);

    param0->unk_10[2] = SpriteResourceCollection_AddFrom(v0->spriteResourceCollection[2], v1, form_display_box_cell_NCER_lz, TRUE, form_display_box_cell_NCER_lz + 14000, SPRITE_RESOURCE_CELL, param2);
    param0->unk_10[3] = SpriteResourceCollection_AddFrom(v0->spriteResourceCollection[3], v1, form_display_box_anim_NANR_lz, TRUE, form_display_box_anim_NANR_lz + 14000, SPRITE_RESOURCE_ANIM, param2);
}
...
static void ov21_021DFE0C(UnkStruct_ov21_021DFFF8 *param0, UnkStruct_ov21_021DF858 *param1, const UnkStruct_ov21_021DF844 *param2, int param3)
{
    ...
    SpriteResourcesHeader_Init(&v0, form_display_box_NCGR_lz + 14000, form_display_box_NCLR + 14000, form_display_box_cell_NCER_lz + 14000, form_display_box_anim_NANR_lz + 14000, 0xffffffff, 0xffffffff, 0, 3, v2->spriteResourceCollection[0], v2->spriteResourceCollection[1], v2->spriteResourceCollection[2], v2->spriteResourceCollection[3], NULL, NULL);

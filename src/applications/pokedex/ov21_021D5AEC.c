...
static void ov21_021D6114(UnkStruct_ov21_021D71A8 *param0, PokedexGraphicData *param1, const UnkStruct_ov21_021D5B68 *param2, int heapID)
{
    PokedexGraphics_LoadGraphicNarcPaletteData(param1, background_scroll_default_NCLR, PAL_LOAD_MAIN_BG, 0, 0, heapID);
...
static void ov21_021D61F4(UnkStruct_ov21_021D71A8 *param0, PokedexGraphicData *param1, const UnkStruct_ov21_021D5B68 *param2, int heapID)
{
    ...
    PokedexGraphics_LoadGraphicNarcPaletteData(param1, register_NCLR, PAL_LOAD_MAIN_BG, 0, 32, heapID);
...
static void ov21_021D62E4(PokedexGraphicData *param0, int heapID)
{
    ...
    v0 = PokedexGraphics_GetGraphicNarcScreenData(param0, scroll_main_background_NSCR_lz, TRUE, &v1, heapID);

    Bg_LoadToTilemapRect(param0->bgConfig, 3, v1->rawData, 0, 0, v1->screenWidth / 8, v1->screenHeight / 8);
    Heap_FreeToHeap(v0);

    v0 = PokedexGraphics_GetGraphicNarcScreenData(param0, register_species_window_NSCR_lz, TRUE, &v1, heapID);
...
static void ov21_021D637C(UnkStruct_ov21_021D71A8 *param0, PokedexGraphicData *param1, int heapID, int param3)
{
    ...
    if (param3 == 1) {
        ...
        v0 = search_local_NSCR_lz;
    }

    param0->unk_D8 = PokedexGraphics_GetGraphicNarcScreenData(param1, v0, TRUE, &param0->unk_DC, heapID);
}
...
static void ov21_021D65DC(UnkStruct_ov21_021D71A8 *param0, PokedexGraphicData *param1, int param2)
{
    ...
    v0 = SpriteResourceCollection_AddPaletteFrom(param0->unk_80[1], v1, buttons_NCLR, FALSE, 3, NNS_G2D_VRAM_TYPE_2DMAIN, 12, param2);
    ...
    SpriteResourcesHeader_Init(&param0->unk_90, search_body_shapes_NCGR_lz, buttons_NCLR, search_body_shapes_cell_NCER_lz, search_body_shapes_anim_NANR_lz, 0xffffffff, 0xffffffff, 0, 2, param0->unk_80[0], param0->unk_80[1], param0->unk_80[2], param0->unk_80[3], NULL, NULL);
    ...
    SpriteResourcesHeader_Init(&param0->unk_B4, unseen_icon_NCGR_lz, buttons_NCLR, unseen_icon_cell_NCER_lz, unseen_icon_anim_NANR_lz, 0xffffffff, 0xffffffff, 0, 2, param0->unk_80[0], param0->unk_80[1], param0->unk_80[2], param0->unk_80[3], NULL, NULL);
}

...
static void ov21_021DCE40(UnkStruct_ov21_021DCAE0 *param0, const UnkStruct_ov21_021DCACC *param1, enum HeapId heapID)
{
    ...
    v0 = PokedexGraphics_GetGraphicNarcScreenData(param0->unk_00, area_map_NSCR_lz, 1, &v1, heapID);
    ...
    if (param1->unk_00->newmoonIslandVisible) {
        v0 = PokedexGraphics_GetGraphicNarcScreenData(param0->unk_00, map_newmoon_island_NSCR_lz, TRUE, &v1, heapID);
    ...
    if (param1->unk_00->seabreakPathVisible) {
        v0 = PokedexGraphics_GetGraphicNarcScreenData(param0->unk_00, map_seabreak_path_NSCR_lz, TRUE, &v1, heapID);
    ...
    if (param1->unk_00->fullmoonIslandVisible) {
        v0 = PokedexGraphics_GetGraphicNarcScreenData(param0->unk_00, map_fullmoon_island_NSCR_lz, TRUE, &v1, heapID);
    ...
    if (param1->unk_00->springPathVisible) {
        v0 = PokedexGraphics_GetGraphicNarcScreenData(param0->unk_00, map_spring_path_NSCR_lz, TRUE, &v1, heapID);
...
static void ov21_021DCFC8(PokedexMapDisplay *mapDisplay, UnkStruct_ov21_021DCAE0 *param1, enum HeapId heapID)
{
    ...
    mapDisplay->unk_B4[2] = SpriteResourceCollection_AddFrom(v0->spriteResourceCollection[2], v1, dungeon_highlight_cell_NCER_lz, TRUE, dungeon_highlight_cell_NCER_lz + 6000, SPRITE_RESOURCE_CELL, heapID);
    mapDisplay->unk_B4[3] = SpriteResourceCollection_AddFrom(v0->spriteResourceCollection[3], v1, dungeon_highlight_anim_NANR_lz, TRUE, dungeon_highlight_anim_NANR_lz + 6000, SPRITE_RESOURCE_ANIM, heapID);
    ...
    mapDisplay->unk_D0[2] = SpriteResourceCollection_AddFrom(v0->spriteResourceCollection[2], v1, size_check_icons_cell_NCER_lz, TRUE, size_check_icons_cell_NCER_lz + 6000, SPRITE_RESOURCE_CELL, heapID);
    mapDisplay->unk_D0[3] = SpriteResourceCollection_AddFrom(v0->spriteResourceCollection[3], v1, size_check_icons_anim_NANR_lz, TRUE, size_check_icons_anim_NANR_lz + 6000, SPRITE_RESOURCE_ANIM, heapID);
}
...
static void ov21_021DD1A8(PokedexMapDisplay *mapDisplay, UnkStruct_ov21_021DCAE0 *param1, enum HeapId heapID)
{
    ...
    SpriteResourcesHeader_Init(&v0, size_check_icons_NCGR_lz + 6000, size_check_icons_NCLR + 6000, size_check_icons_cell_NCER_lz + 6000, size_check_icons_anim_NANR_lz + 6000, 0xffffffff, 0xffffffff, 0, 1, v2->spriteResourceCollection[0], v2->spriteResourceCollection[1], v2->spriteResourceCollection[2], v2->spriteResourceCollection[3], NULL, NULL);
    ...
    SpriteResourcesHeader_Init(&v0, dungeon_highlight_NCGR_lz + 6000, size_check_icons_NCLR + 6000, dungeon_highlight_cell_NCER_lz + 6000, dungeon_highlight_anim_NANR_lz + 6000, 0xffffffff, 0xffffffff, 0, 0, v2->spriteResourceCollection[0], v2->spriteResourceCollection[1], v2->spriteResourceCollection[2], v2->spriteResourceCollection[3], NULL, NULL);

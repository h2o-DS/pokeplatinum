...
static void ov21_021E4590(UnkStruct_ov21_021E4360 *param0, UnkStruct_ov21_021E4108 *param1, const UnkStruct_ov21_021E40F4 *param2, const UnkStruct_ov21_021E4898 *param3, int heapID);
static void ov21_021E45DC(UnkStruct_ov21_021E4360 *param0, UnkStruct_ov21_021E4108 *param1);
static void ov21_021E45FC(UnkStruct_ov21_021E4108 *param0, const UnkStruct_ov21_021E40F4 *param1, int heapID);
...
static void ov21_021E45FC(UnkStruct_ov21_021E4108 *param0, const UnkStruct_ov21_021E40F4 *param1, int heapID)
{
    ...
    v0 = PokedexGraphics_GetGraphicNarcScreenData(param0->unk_00, cry_button_NSCR_lz, TRUE, &v1, heapID);
...
static void ov21_021E46A8(UnkStruct_ov21_021E4360 *param0, UnkStruct_ov21_021E4108 *param1, int param2)
{
    ...
    param0->unk_314[0] = SpriteResourceCollection_AddTilesFrom(v0->spriteResourceCollection[0], v1, dummy4_NCGR_lz, TRUE, dummy4_NCGR_lz + 11000, NNS_G2D_VRAM_TYPE_2DMAIN, param2);

    SpriteTransfer_RequestCharAtEnd(param0->unk_314[0]);
    SpriteResource_ReleaseData(param0->unk_314[0]);

    param0->unk_314[1] = SpriteResourceCollection_AddPaletteFrom(v0->spriteResourceCollection[1], v1, dummy4_NCLR, FALSE, dummy4_NCLR + 11000, NNS_G2D_VRAM_TYPE_2DMAIN, 1, param2);

    SpriteTransfer_RequestPlttFreeSpace(param0->unk_314[1]);
    SpriteResource_ReleaseData(param0->unk_314[1]);

    param0->unk_314[2] = SpriteResourceCollection_AddFrom(v0->spriteResourceCollection[2], v1, dummy4_cell_NCER_lz, TRUE, dummy4_cell_NCER_lz + 11000, SPRITE_RESOURCE_CELL, param2);
    param0->unk_314[3] = SpriteResourceCollection_AddFrom(v0->spriteResourceCollection[3], v1, dummy4_anim_NANR_lz, TRUE, dummy4_anim_NANR_lz + 11000, SPRITE_RESOURCE_ANIM, param2);
}
...
static void ov21_021E47CC(UnkStruct_ov21_021E4360 *param0, UnkStruct_ov21_021E4108 *param1, int param2)
{
    ...
    SpriteResourcesHeader_Init(&v0, dummy4_NCGR_lz + 11000, dummy4_NCLR + 11000, dummy4_cell_NCER_lz + 11000, dummy4_anim_NANR_lz + 11000, 0xffffffff, 0xffffffff, 0, 0, v2->spriteResourceCollection[0], v2->spriteResourceCollection[1], v2->spriteResourceCollection[2], v2->spriteResourceCollection[3], NULL, NULL);

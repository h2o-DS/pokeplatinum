...
static void ov21_021D7CD8(PokedexGraphicData **param0, const UnkStruct_ov21_021D77D4 *param1, enum HeapId heapID)
{
    ...
    PokedexGraphics_LoadGraphicNarcPaletteData(*param0, background_scroll_default_NCLR, PAL_LOAD_SUB_BG, 0, 0, heapID);

    if (param1->unk_1C->unk_04->unk_1740 == 1) {
        PokedexGraphics_LoadGraphicNarcPaletteData(*param0, background_scroll_local_NCLR, PAL_LOAD_SUB_BG, 3 * 32, 32, heapID);
    } else {
        if (PokedexSort_IsNationalDex(param1->unk_1C->unk_04) == 1) {
            PokedexGraphics_LoadGraphicNarcPaletteData(*param0, scroll_buttons_national_NCLR, PAL_LOAD_SUB_BG, 3 * 32, 32, heapID);
        }
    }

    PokedexGraphics_LoadGraphicNarcCharacterData(*param0, scroll_sub_background_NCGR_lz, v2, 6, 0, 0, TRUE, heapID);

    v0 = PokedexGraphics_GetGraphicNarcScreenData(*param0, scroll_sub_NSCR_lz, TRUE, &v1, heapID);
...
static void ov21_021D7D8C(UnkStruct_ov21_021D7C64 *param0, PokedexGraphicData **param1, int param2)
{
    ...
    param0->unk_2C[2] = SpriteResourceCollection_AddFrom(v0->spriteResourceCollection[2], v1, scroll_buttons_cell_NCER_lz, TRUE, scroll_buttons_cell_NCER_lz + 1000, SPRITE_RESOURCE_CELL, param2);
    param0->unk_2C[3] = SpriteResourceCollection_AddFrom(v0->spriteResourceCollection[3], v1, scroll_buttons_anim_NANR_lz, TRUE, scroll_buttons_anim_NANR_lz + 1000, SPRITE_RESOURCE_ANIM, param2);
}
...
static void ov21_021D7E80(UnkStruct_ov21_021D7C64 *param0, PokedexGraphicData **param1, const UnkStruct_ov21_021D77D4 *param2, int param3)
{
    ...
    SpriteResourcesHeader_Init(&v0, scroll_buttons_NCGR_lz + 1000, buttons_NCLR + 1000, scroll_buttons_cell_NCER_lz + 1000, scroll_buttons_anim_NANR_lz + 1000, 0xffffffff, 0xffffffff, 0, 0, v2->spriteResourceCollection[0], v2->spriteResourceCollection[1], v2->spriteResourceCollection[2], v2->spriteResourceCollection[3], NULL, NULL);
...
static void ov21_021D820C(PokedexGraphicData **param0, int heapID)
{
    ...
    v0 = PokedexGraphics_GetGraphicNarcScreenData(*param0, scroll_wheel_NSCR_lz, TRUE, &v1, heapID);

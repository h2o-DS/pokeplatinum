...
static void ov21_021E20A4(PokedexGraphicData **param0, int heapID)
{
    ...
    v0 = PokedexGraphics_GetGraphicNarcScreenData(*param0, info_sub_NSCR_lz, TRUE, &v1, heapID);

    Bg_LoadToTilemapRect((*param0)->bgConfig, 6, v1->rawData, 0, 0, v1->screenWidth / 8, v1->screenHeight / 8);
    Heap_FreeToHeap(v0);

    v0 = PokedexGraphics_GetGraphicNarcScreenData(*param0, info_sub_unpressed_NSCR_lz, TRUE, &v1, heapID);

    Bg_LoadToTilemapRect((*param0)->bgConfig, 6, v1->rawData, ((128 - (160 / 2)) / 8), ((132 - (40 / 2)) / 8), v1->screenWidth / 8, v1->screenHeight / 8);
    Heap_FreeToHeap(v0);

    v0 = PokedexGraphics_GetGraphicNarcScreenData(*param0, info_sub_pressed_NSCR_lz, TRUE, &v1, heapID);
...
static void ov21_021E2180(UnkStruct_ov21_021E2588 *param0, PokedexGraphicData **param1, int param2)
{
    ...
    param0->unk_40[2] = SpriteResourceCollection_AddFrom(v0->spriteResourceCollection[2], v1, size_buttons_pressed_cell_NCER_lz, TRUE, size_buttons_pressed_cell_NCER_lz + 5000, SPRITE_RESOURCE_CELL, param2);
    param0->unk_40[3] = SpriteResourceCollection_AddFrom(v0->spriteResourceCollection[3], v1, size_buttons_pressed_anim_NANR_lz, TRUE, size_buttons_pressed_anim_NANR_lz + 5000, SPRITE_RESOURCE_ANIM, param2);
    ...
    param0->unk_70[2] = SpriteResourceCollection_AddFrom(v0->spriteResourceCollection[2], v1, info_language_buttons_cell_NCER_lz, TRUE, info_language_buttons_cell_NCER_lz + 5000, SPRITE_RESOURCE_CELL, param2);
    param0->unk_70[3] = SpriteResourceCollection_AddFrom(v0->spriteResourceCollection[3], v1, info_language_buttons_anim_NANR_lz, TRUE, info_language_buttons_anim_NANR_lz + 5000, SPRITE_RESOURCE_ANIM, param2);
}
...
static void ov21_021E26A0(PokedexGraphicData **param0, Sprite *param1, PokedexTextData *textData, int param3, int param4, int param5, int *param6, int heapID, int param8, int param9, void **param10)
{
    ...
    if (v3) {
        ...
        *param10 = PokedexGraphics_GetGraphicNarcPaletteData(*param0, palette, &v1, heapID);

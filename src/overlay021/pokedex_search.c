...
static PokedexScreenState *ov21_021D874C(enum HeapId heapID, PokedexApp *param1);
static void FreeSearchSettings(PokedexSearchSettings *searchSettings);
static void ov21_021D879C(PokedexGraphicData **param0);
static void ov21_021D87B0(PokedexScreenState *param0);
...
void PokedexSearch_TransitionFunctions(PokedexScreenManager *param0, PokedexApp *param1, enum HeapId heapID)
{
    ...
    PokedexScreenState *pokedexScreenState = ov21_021D874C(heapID, param1);

    param0->operationalData = searchSettings;
    param0->graphicData = v1;
    param0->pokedexScreenState = pokedexScreenState;
    param0->numScreenStates = ov21_021D87C8();

    param0->dataTransition[POKEDEX_TRANSITION_IN] = ResetSearchSettings;
    param0->dataTransition[POKEDEX_TRANSITION_UPDATE] = UpdateScreenState;
    param0->dataTransition[POKEDEX_TRANSITION_OUT] = ov21_021D8928;
    param0->displayTransition[POKEDEX_TRANSITION_IN] = EnterPokedexSearch;
    param0->displayTransition[POKEDEX_TRANSITION_UPDATE] = UpdateDisplay;
    param0->displayTransition[POKEDEX_TRANSITION_OUT] = ExitPokedexSearch;
}

void PokedexSearch_FreeData(PokedexScreenManager *param0)
{
    FreeSearchSettings(param0->operationalData);
    ov21_021D879C(param0->graphicData);
    ov21_021D87B0(param0->pokedexScreenState);
}

void PokedexSearch_SetFilterMethod(PokedexScreenManager *param0, enum FilterMethod filterMethod)
{
    PokedexSearchSettings *searchSettings = param0->operationalData;
...
{
    const PokedexSearchSettings *searchSettings = param0->operationalData;
...
static PokedexSearchSettings *InitSearchSettings(enum HeapId heapID, PokedexApp *param1)
{
    ...
    PokedexScreenManager *v1 = PokedexMain_GetTopScreen(param1, 0);
    searchSettings->unk_08 = v1->operationalData;
...
static PokedexScreenState *ov21_021D874C(enum HeapId heapID, PokedexApp *param1)
{
    ...
    PokedexScreenState *v0 = Heap_AllocFromHeap(heapID, sizeof(PokedexScreenState) * v1);
...
static void ov21_021D8B8C(PokedexGraphicData **param0, const PokedexSearchSettings *searchSettings, enum HeapId heapID)
{
    Pokedex_LoadGraphicNarcCharacterData(*param0, 28, (*param0)->bgConfig, 3, 0, 0, 1, heapID);
    Pokedex_LoadGraphicNarcPaletteData(*param0, 5, 0, 0, 32, heapID);
}
...
static void GetDisplayMap(PokedexSearchDisplay *searchDisplay, PokedexGraphicData **param1, const PokedexSearchSettings *searchSettings, enum HeapId heapID, int param4)
{
    ...
    searchDisplay->tileMap = Pokedex_GetGraphicNarcScreenData(*param1, mapIndex, 1, &searchDisplay->screenData, heapID);
}
...
static void GetSearchGraphics(PokedexSearchDisplay *searchDisplay, PokedexGraphicData **param1, enum HeapId heapID)
{
    ...
    NARC *pokedexGraphics = Pokedex_PokedexGraphicsNARC(v0);
...
static void FilterMethodMap(PokedexGraphicData **param0, int filterMethod, enum HeapId heapID)
{
    ...
    v0 = Pokedex_GetGraphicNarcScreenData(*param0, 43, 1, &v1, heapID);
    ...
    v0 = Pokedex_GetGraphicNarcScreenData(*param0, mapIndex, 1, &v1, heapID);

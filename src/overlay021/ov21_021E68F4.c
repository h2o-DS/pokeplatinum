...
static PokedexScreenState *ov21_021E69D8(enum HeapId heapID, PokedexApp *param1);
static void ov21_021E6A20(UnkStruct_ov21_021E6A20 *param0);
static void ov21_021E6A34(PokedexGraphicData **param0);
static void ov21_021E6A48(PokedexScreenState *param0);
static int ov21_021E6A68(void);
static int ov21_021E6A6C(PokedexDataManager *param0, void *param1);
static int ov21_021E6AB8(PokedexDataManager *param0, void *param1);
static int ov21_021E6B0C(PokedexDataManager *param0, void *param1);
static int ov21_021E6B20(void *param0, PokedexGraphicsManager *param1, const void *param2, const PokedexDataManager *param3);
static int ov21_021E6BA8(void *param0, PokedexGraphicsManager *param1, const void *param2, const PokedexDataManager *param3);
static int ov21_021E6BD8(void *param0, PokedexGraphicsManager *param1, const void *param2, const PokedexDataManager *param3);
...
static void ov21_021E71D0(PokedexGraphicData **param0, Sprite *param1, PokedexTextManager *param2, int param3, int param4, int param5, int *param6, int param7, int param8, int param9, void **param10);
static void ov21_021E727C(Sprite *param0, PokedexTextManager *param1, int param2, int param3, int param4);
...
static void ov21_021E6E64(UnkStruct_ov21_021E6C60 *param0, PokedexGraphicData **param1, int param2);
static void ov21_021E6E94(UnkStruct_ov21_021E6C60 *param0, PokedexGraphicData **param1, int param2);
static void ov21_021E6EF0(PokedexGraphicData **param0, int param1);
...
void ov21_021E68F4(PokedexScreenManager *param0, PokedexApp *param1, enum HeapId heapID)
{
    ...
    pokedexScreenState = ov21_021E69D8(heapID, param1);

    param0->operationalData = v0;
    param0->graphicData = v1;
    param0->pokedexScreenState = pokedexScreenState;
    param0->numScreenStates = ov21_021E6A68();

    param0->dataTransition[POKEDEX_TRANSITION_IN] = ov21_021E6A6C;
    param0->dataTransition[POKEDEX_TRANSITION_UPDATE] = ov21_021E6AB8;
    param0->dataTransition[POKEDEX_TRANSITION_OUT] = ov21_021E6B0C;
    param0->displayTransition[POKEDEX_TRANSITION_IN] = ov21_021E6B20;
    param0->displayTransition[POKEDEX_TRANSITION_UPDATE] = ov21_021E6BA8;
    param0->displayTransition[POKEDEX_TRANSITION_OUT] = ov21_021E6BD8;
}

void ov21_021E6954(PokedexScreenManager *param0)
{
    ov21_021E6A20(param0->operationalData);
    ov21_021E6A34(param0->graphicData);
    ov21_021E6A48(param0->pokedexScreenState);
}
...
static UnkStruct_ov21_021E6A20 *ov21_021E696C(enum HeapId heapID, PokedexApp *param1)
{
    ...
    v0->unk_0C = PokedexMain_GetBottomScreen(param1, 3);
    v0->unk_04 = 0;
...
static int ov21_021E6A6C(PokedexDataManager *param0, void *param1)
{
    ...
    UnkStruct_ov21_021E6DAC *v1 = param0->pageData;
    int v2;
...
static int ov21_021E6B20(void *param0, PokedexGraphicsManager *graphicsMan, const void *param2, const PokedexDataManager *param3)
{
    const UnkStruct_ov21_021E6A20 *v0 = param2;
    const UnkStruct_ov21_021E6DAC *v1 = param3->pageData;
...
static int ov21_021E6BA8(void *param0, PokedexGraphicsManager *graphicsMan, const void *param2, const PokedexDataManager *param3)
{
    const UnkStruct_ov21_021E6A20 *v0 = param2;
    const UnkStruct_ov21_021E6DAC *v1 = param3->pageData;
    PokedexGraphicData **v2 = param0;
...
static int ov21_021E6BD8(void *param0, PokedexGraphicsManager *graphicsMan, const void *param2, const PokedexDataManager *param3)
{
    const UnkStruct_ov21_021E6A20 *v0 = param2;
    const UnkStruct_ov21_021E6DAC *v1 = param3->pageData;
    PokedexGraphicData **v2 = param0;
...
static void ov21_021E6D58(UnkStruct_ov21_021E6DAC *param0, UnkStruct_ov21_021E6A20 *param1, enum HeapId heapID)
{
    ...
    PokedexMain_SetHitTableBoundaries(&param0->unk_04[0], 120 - (112 / 2), 120 + (112 / 2), 68 - (120 / 2), 68 + (120 / 2));
    PokedexMain_SetHitTableBoundaries(&param0->unk_04[1], 120 - (112 / 2), 120 + (112 / 2), 188 - (120 / 2), 188 + (120 / 2));
...
static void ov21_021E6EF0(PokedexGraphicData **param0, int param1)
{
    ...
    v0 = Pokedex_GetGraphicNarcScreenData(*param0, 61, 1, &v1, param1);
...
static void ov21_021E70D4(UnkStruct_ov21_021E6C60 *param0, PokedexGraphicData **param1, int param2)
{
    ...
    v0 = Pokedex_NewWindow(v3->unk_14C, 12, 2);
...
static void ov21_021E7368(PokedexGraphicData **param0, int param1, int param2, int param3, int param4)
{
    ...
    PokedexCursor_CursorTransformation(v0, param1, param2, param3, param4);
}

...
static void ov21_021E0F4C(UnkStruct_ov21_021E14D4 *param0, PokedexGraphicData **param1, const UnkStruct_ov21_021E0D68 *param2, int param3);
static void ov21_021E0F94(UnkStruct_ov21_021E14D4 *param0, PokedexGraphicData **param1);
static void ov21_021E0FBC(PokedexGraphicData **param0, int param1);
...
void ov21_021E0C68(PokedexScreenManager *param0, PokedexApp *param1, enum HeapId heapID)
{
    ...
    param0->numScreenStates = ov21_021E0D90();

    param0->dataTransition[POKEDEX_TRANSITION_IN] = ov21_021E0D94;
    param0->dataTransition[POKEDEX_TRANSITION_UPDATE] = ov21_021E0D98;
    param0->dataTransition[POKEDEX_TRANSITION_OUT] = ov21_021E0DA8;
    param0->displayTransition[POKEDEX_TRANSITION_IN] = ov21_021E0DAC;
    param0->displayTransition[POKEDEX_TRANSITION_UPDATE] = ov21_021E0E8C;
    param0->displayTransition[POKEDEX_TRANSITION_OUT] = ov21_021E0E90;
}

void ov21_021E0CC0(PokedexScreenManager *param0)
{
    ov21_021E0D68(param0->operationalData);
    ov21_021E0D7C(param0->graphicData);
}

void ov21_021E0CD4(PokedexScreenManager *param0, int param1, int param2)
{
    UnkStruct_ov21_021E0D68 *v0 = param0->operationalData;
...
static void ov21_021E0FBC(PokedexGraphicData **param0, int param1)
{
    ...
    v0 = Pokedex_GetGraphicNarcScreenData(*param0, 55, 1, &v1, param1);

    Bg_LoadToTilemapRect((*param0)->bgConfig, 3, v1->rawData, 0, 16, v1->screenWidth / 8, v1->screenHeight / 8);
    Heap_FreeToHeap(v0);

    v0 = Pokedex_GetGraphicNarcScreenData(*param0, 56, 1, &v1, param1);
...
static void ov21_021E136C(UnkStruct_ov21_021E14D4 *param0, PokedexGraphicData **param1, const UnkStruct_ov21_021E0D68 *param2, int heapID)
{
...
static Window *ov21_021E1460(PokedexGraphicData **param0, int param1, int param2)
{
    ...
    v0 = Pokedex_NewWindow((*param0)->unk_14C, 18, 2);
...

    {
        ...
        Pokedex_DisplayText((*param0)->unk_14C, v0, v1, v3, 0);
    }
...
static void ov21_021E17EC(UnkStruct_ov21_021E14D4 *param0, int param1, int param2, int param3)
{
    PokedexCursor_InitTransformation(&param0->unk_18, 48, param1, 72, param2, param3);
}
...
static BOOL ov21_021E1808(UnkStruct_ov21_021E14D4 *param0, PokedexGraphicData **param1)
{
    ...
    v0 = PokedexCursor_TakeStep(&param0->unk_18);
    ov21_021D2164(*param1, param0->unk_18.currentX, param0->unk_18.currentY);
...
static void ov21_021E1824(UnkStruct_ov21_021E14D4 *param0)
{
    PokedexCursor_InitTransformation(&param0->unk_38, 172, 170, 32, 82, 4);
}
...
static BOOL ov21_021E1840(UnkStruct_ov21_021E14D4 *param0, PokedexGraphicData **param1)
{
    ...
    v0 = PokedexCursor_TakeStep(&param0->unk_38);
